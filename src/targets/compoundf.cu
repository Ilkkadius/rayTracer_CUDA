...
__device__ void Compound::translate(const Vector3D& vec) {
    for(int i = 0; i < size; i++) {
...
__device__ void Compound::rotate(float angle, const Vector3D& axis) {
...
__device__ void Tetrahedron::makeTetrahedron(const Vector3D& center, float radius, const Vector3D& color) {
...
__device__ Icosahedron::Icosahedron(const Vector3D& center, float radius, const Vector3D& color)
            : Compound(20) {
                makeIcosahedron(center, radius, color);
            }


__device__ void Icosahedron::makeIcosahedron(const Vector3D& center, float radius, const Vector3D& color) {
    float R = radius;
...
__device__ Pentagon::Pentagon(const Vector3D& v1, const Vector3D& v2, const Vector3D& v3, const Vector3D& v4, const Vector3D& v5, const Vector3D& color)
...
__device__ void Dodecahedron::makeDodecahedron(const Vector3D& center, float radius, const Vector3D& color) {
    float R = radius;
...
__device__ Octahedron::Octahedron(const Vector3D& center, float radius, const Vector3D& color)
            : Compound(8) {makeOctahedron(center, radius, color);}

__device__ void Octahedron::makeOctahedron(const Vector3D& center, float radius, const Vector3D& color) {
    float R = radius;
...
__device__ Cube::Cube(const Vector3D& center, float radius, const Vector3D& color)
    : Compound(12) {buildCube(center, radius, color);}

__device__ void Cube::buildCube(const Vector3D& center, float radius, const Vector3D& color) {

...
__device__ void Scene::testScene(TargetList** list, Target** targets, Shape** shapes, int capacity) {
    //float r = 500;
...
__device__ void Scene::empty(TargetList** list, Target** targets, Shape** shapes, int capacity) {
    *list = new TargetList(targets, 0, capacity);
}

__device__ void Scene::Platon(TargetList** list, Target** targets, Shape** shapes, int capacity) {
